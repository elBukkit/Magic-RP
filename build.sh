...
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-skulls-RP-26.1.zip *
cd ..
...
cp -R ../../src/painterly/* .
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-painterly-RP-26.1.zip *
cd ..
...
cp -R ../../src/lowres/* .
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-lowres-RP-26.1.zip *
cd ..
...
cp -R ../../src/potter/* .
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-potter-RP-26.1.zip *
cd ..
...
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-war-RP-26.1.zip *
cd ..
...
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-robes-RP-26.1.zip *
cd ..
...
cp -R ../../src/httyd/* .
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-httyd-RP-26.1.zip *
cd ..
...
cp -R ../../src/brawl/* .
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-brawl-RP-26.1.zip *
cd ..
...
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-all-RP-26.1.zip *
cd ..
...
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-modelengine-RP-26.1.zip *
cd ..
...
cp -R ../../src/hires/* .
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-hires-modelengine-RP-26.1.zip *
cd ..
...
cp -R ../../src/hires/* .
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-hires-all-RP-26.1.zip *
cd ..
...
cp -R ../../src/hires/* .
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-hires-robes-RP-26.1.zip *
cd ..
...
cp -R ../../src/hires/* .
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-hires-RP-26.1.zip *
cd ..
...
cp -R ../../src/vanilla/* .
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-vanilla-RP-26.1.zip *
cd ..
...
cp -R ../../src/vanilla/* .
find . -name ".DS_Store" -type f -delete
zip -q -X -r ../Magic-vanilla-all-RP-26.1.zip *
cd ..
